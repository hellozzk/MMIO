...
## Cases where some bounding boxes are offset can be used as negative samples during training. These do not affect the test set accuracy of RTVPNet in actual testing.
